			...
			<tr>
					...
					<fieldset class="parallel_target">
						...
						<div id="which_collection_hide_saved">
							...
							<select name="collivery_from" id="collivery_from">
								...
								<option <?php
									if ( $defaults['default_address_id'] == $address['address_id'] ) echo 'selected="selected"';
				...
				<td style="width:38%;">
					<fieldset class="parallel_target">
						...
						<input type="text" name="collection_time" id="datetimepicker4" value=""/><input id="open" type="button" value="open"/><input id="close" type="button" value="close"/>
