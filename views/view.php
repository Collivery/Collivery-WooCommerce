...
<span>Back to </span><a href="<?php echo get_site_url().'/wp-admin/admin.php?page=mds-already-confirmed';?>">MDS Confirmed</a><br />
<br />
<div class="parallel">
	<table width="100%">
		<tbody>
			...
			<tr>
				<td width="50%">
					<fieldset class="parallel_target" style="background-color: #E0E0E0;">
						...
						<?php if ( isset( $collection_address['nice_address'] ) && $collection_address['nice_address'] != "" ) {echo '<p>'.$collection_address['nice_address'].'</p>';}?>
						<?php
							$collection_count = 1;
				...
				<td width="50%">
					<fieldset class="parallel_target" style="background-color: #E0E0E0;">
						...
						<?php if ( isset( $destination_address['nice_address'] ) && $destination_address['nice_address'] != "" ) {echo '<p>'.$destination_address['nice_address'].'</p>';}?>
						<?php
						$destination_count = 1;
