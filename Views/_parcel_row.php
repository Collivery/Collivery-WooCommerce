...
<?php endforeach; ?>
    ...
    <td>
        <input type="number" name="<?php echo isset($count) ? "parcels[$count][quantity]" : ''; ?>" value="<?php echo isset($parcel['qty']) ? $parcel['qty'] : isset($parcel['quantity']) ? $parcel['quantity'] : 1 ?>" placeholder="pcs" class="<?php echo isset($count) ? ' parcel_qty' : ''; ?>" rel="qty" min="1" style="width: 53px;">
    </td>
