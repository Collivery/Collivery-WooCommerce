...
if( is_plugin_active('woocommerce/woocommerce.php')) {
    ...
    if ($mds->isEnabled()) {
        ...
        if (!function_exists('mds_collivery_remove_checkout_optional_text')) {
            /**
             * Remove optional text from checkout fieldsthe address fields to the order
             * $order_id is generated by WooCommerce and does not contain the suburb/town names,
             * use id's to get the names
             *
             * @param string $postString
            ...
            function mds_collivery_remove_checkout_optional_text($field, $key, $args, $value)
            {
            ...
            add_filter('woocommerce_form_field', 'mds_collivery_remove_checkout_optional_text', 10, 4);
